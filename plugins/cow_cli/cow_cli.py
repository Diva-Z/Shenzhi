...
class CowCliPlugin(Plugin):
    ...
    def _cmd_version(self, args: str, e_context, **_) -> str:
        return f"ShenZhi v{__version__}"
    ...
    def _cmd_status(self, args: str, e_context: EventContext, session_id: str = "", **_) -> str:
        ...
        cfg = conf()
        lines = [_t("📊 ShenZhi 运行状态", "📊 ShenZhi Status"), ""]
    ...
    def _find_log_file(self) -> str:
        ...
        candidates = [
            os.path.join(project_root, "shenzhi.out"),
    ...
    def _cmd_install_browser(self, args: str, e_context, **_) -> str:
        ...
        return _t(
            "✅ 安装流程已结束。请重启 ShenZhi 后使用 browser 工具（进度见上方消息）。",
            "✅ Installation finished. Restart ShenZhi to use the browser tool (see messages above for progress).",
        )
